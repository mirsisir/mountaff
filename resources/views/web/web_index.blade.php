        ...
        <div class="container d-flex h-100">
            <div class="row justify-content-center align-self-center" data-aos="fade-up">
                <div class="col-lg-6 intro-info order-lg-first order-last" data-aos="zoom-in" data-aos-delay="100">
                    <h2>Your Smartlink. Your CPA. Your ONE Network<br>for Your <span>Business!</span></h2>
                    <div>
                ...
                <div class="row">
                    ...
                    <div class="col-lg-7 col-md-6">
                        <div class="about-content" data-aos="fade-left" data-aos-delay="100">
                            <h2>About Us</h2>
                            <h3>CPA and Smartlink platform with FREE tracker that allows to monetize all (100%)
                                available WORLDWIDE traffic. We work with all types of traffic: app, social,
                                search, native, banner, email, push.</h3>
                            <p class="text-justify">establishing a name for itself as one of the world's leading
                                performance based online ad
                                networks. As a strong, trustful and leading link in the industry we are committed to
                                change the face of online advertising for advertisers, publishers and end users.

                                While working on an international level providing services to advertisers, publishers
                                and agencies, we are constantly developing and searching for new technologies and
                                products that will enable us to better optimize and drive higher results.

                                We are dedicated to generate and optimize the revenue for both our advertisers and
                                publishers. Our optimization system enables Advertisers to implement highly effective
                ...
                <div class="row g-5">
                    ...
                    <div class="col-md-6 col-lg-4 wow bounceInUp" data-aos="zoom-in" data-aos-delay="100">
                        <div class="box">
                            ...
                            <h4 class="title"><a href="">CPA offers</a></h4>
                            <p class="description">get access to a great amount of the best exclusive and direct
                                worldwide offers</p>
                        </div>
                    </div>
                    <div class="col-md-6 col-lg-4" data-aos="zoom-in" data-aos-delay="200">
                        <div class="box">
                            ...
                            <h4 class="title"><a href="">SmartLink</a></h4>
                            <p class="description">all offers in one link. Our algorithms monetize 100% of your traffic
                    ...
                    <div class="col-md-6 col-lg-4" data-aos="zoom-in" data-aos-delay="300">
                        <div class="box">
                            ...
                            <h4 class="title"><a href="">Smart tech</a></h4>
                            <p class="description">first technology of Auto Targeting allows to get maximum profit from
                    ...
                    <div class="col-md-6 col-lg-4 wow" data-aos="zoom-in" data-aos-delay="100">
                        <div class="box">
                            ...
                            <h4 class="title"><a href="">Unique platform</a></h4>
                            <p class="description">You don’t have to choose between CPA Offers and smartlink, run both
                                at the same time
                                <!doctype html>
                                <html lang="en">
                                <head>
                    ...
                    <div class="col-md-6 col-lg-4" data-aos="zoom-in" data-aos-delay="200">
                        <div class=" box">
                            ...
                            <h4 class="title"><a href="">Verticals</a></h4>
                            <p class="description">Best converting verticals: Mainstream, Dating, Gaming, CPI, Finance,
                                iGaming</p>
                        </div>
                    </div>
                    ...
                    <div class="col-md-6 col-lg-4" data-aos="zoom-in" data-aos-delay="300">
                        <div class="box">
                            ...
                            <h4 class="title"><a href="">GEOs</a></h4>
                            <p class="description">Our offers cover more than 50 countries with the best EPCs</p>
                        </div>
                    </div>
                ...
                <div class="row">
                    ...
                    <div class="col-lg-6" data-aos="zoom-in" data-aos-delay="100">
                        <div class="why-us-img">
                            <img src="{{asset('web/assets/img/why-us.jpg')}}" alt="" class="img-fluid">
                        </div>
                    </div>
                    ...
                    <div class="col-lg-6">
                        <div class="why-us-content">
                            ...
                            <p>
                                ...
                                Only the best offers at the affiliate’s
                                request and for TOP partners we always have something special in stock.
                            </p>
                            ...
                            <div class="features clearfix" data-aos="fade-up" data-aos-delay="100">
                                ...
                                <p>Get a list of exclusive and in-house offers with high payouts based on CPA, CPL
                                    ...
                                    managers pick
                                    only the best offers at the affiliate’s
                                    request and for TOP partners we always have something special in stock.</p>
                            </div>

                            <div class="features clearfix" data-aos="fade-up" data-aos-delay="200">
                                <i class="bi bi-box-seam" style="color: #ffb774;"></i>
                                <h4>Smart link</h4>
                                <p> Our smart link optimizes your campaign down to an individual prelander’s
                                    performance, and we supply only working creatives. You don’t need to spend resources
                                    testing them– we test them for you.worked in the dating vertical for almost 7 years, and we have partnerships to show for
                                    it. Competitive rates and conditions guaranteed.
                                </p>
                            </div>
                            ...
                            <div class="features clearfix" data-aos="fade-up" data-aos-delay="300">
                                ...
                                <h4>Advertiser</h4>
                                <p>Smartlink payouts are no longer fixed! If your traffic works well for the advertiser –
                                    offer conditions will reflect the performance of your leads. In addition, the monthly
                                    payment threshold can be switched to a weekly payout after traffic quality approval.</p>
                            </div>
            ...
            <div class="container" data-aos="fade-up">
                ...
                <div class="row feature-item">
                    ...
                    <div class="col-lg-6 wow fadeInUp pt-5 pt-lg-0" data-aos="fade-left" data-aos-delay="150">
                        ...
                        <p>
                            Get global offer coverage - we accept 200+ GEOs, all devices and platforms.
                        </p>
                    </div>
                </div>
                ...
                <div class="row feature-item mt-5 pt-5">
                    <div class="col-lg-6 wow fadeInUp order-1 order-lg-2" data-aos="fade-left" data-aos-delay="100">
                        <img src="{{asset('web/assets/img/features-2.svg')}}" class="img-fluid" alt="">
                    </div>
                ...
                <ul class="faq-list" data-aso="fade-up" data-aos-delay="100">
                    ...
                    <li>
                        ...
                        <div id="faq1" class="collapse" data-bs-parent=".faq-list">
                            <p>
                                In times when traffic is no longer an issue we believe each advertiser deserves to reach
                                its ideal public. Whether you are looking to develop brand awareness, generate new leads
                                or increase sales. We will make it work for you!! We mix innovating technology, human
                                insight and professional experience to locate a specific audience on over 50 channels,
                                and to target and optimize a perfected approach.

                                Now all that is left for you to do is to simply join us and you'll gain access to high
                    ...
                    <li>
                        <div data-bs-toggle="collapse" href="#faq2" class="collapsed question">What is Affiliate
                            Marketing? <i class="bi bi-chevron-down icon-show"></i><i
                                    class="bi bi-chevron-up icon-close"></i></div>
                        <div id="faq2" class="collapse" data-bs-parent=".faq-list">
                            <p>
                                Affiliate marketing is the act of placing creative materials in front of potential
                                consumers in hopes that they will be interested in the product or service and act on
                                that advertising effort. Affiliates make a percentage of the sale for each valid action.
                            </p>
                        </div>
                    </li>

                    <li>
                        <div data-bs-toggle="collapse" href="#faq3" class="collapsed question">How do i get paid
                            Bi-weekly? <i
                    ...
                    <li>
                        <div data-bs-toggle="collapse" href="#faq4" class="collapsed question">How often do you pay?<i
                                    class="bi bi-chevron-down icon-show"></i><i
                                    class="bi bi-chevron-up icon-close"></i></div>
                        <div id="faq4" class="collapse" data-bs-parent=".faq-list">
                            <p>
                                We typically run monthly billing cycles, paying the majority of our affiliates on a
                                net-30 basis. Though we do offer
                                flexibility and pay many of our partners net-15 payouts. For our best affiliates, we
                                offer a variety of much faster
                                payment plans - many receive bi-weekly payments.
                            </p>
                        </div>
                    </li>

                    <li>
                        <div data-bs-toggle="collapse" href="#faq5" class="collapsed question">Why was my application
                            denied?
                    ...
                    <li>
                        <div data-bs-toggle="collapse" href="#faq6" class="collapsed question">I haven't received my
                            wire? <i
                                    class="bi bi-chevron-down icon-show"></i><i class="bi bi-chevron-up icon-close"></i>
                        </div>
                    ...
                    <li>
                        ...
                        <div id="faq6" class="collapse" data-bs-parent=".faq-list">
                            <p>
                                We have many automated tools in place to alert us to possible fraud. Our team also
                                monitors the activities of merchants and
                                affiliates alike, to make sure that there is no suspicious activity. ALL checks are
                                reviewed before they are sent,
                                and fraudulent users will NOT be paid ANY commissions. The fact is that most people who
                                attempt to fraud merchants or
                                affiliates, are not very good at it, and are easy to spot, catch, and terminate from the
                                network.
                                We have a ZERO tolerance policy for fraud, no exceptions, no second chances. </p>
                        </div>
                    </li>
